  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        navy: "bg-navy text-navy-foreground hover:bg-navy-soft hover:-translate-y-0.5",
        electric:
          "bg-electric text-electric-foreground hover:brightness-110 hover:-translate-y-0.5",
        ember: "bg-ember text-ember-foreground shadow-[0_10px_24px_-12px_var(--ember)] hover:brightness-105 hover:-translate-y-0.5",
        onDark:
